<template>
  <TopNavigation />
  <NavigationVue />
  <div id="SubmitForgetPassword" class="antialiased bg-gray-200">
    <div class="w-full  flex justify-center items-center ">
        ...
        <h1 class="w-full  flex justify-center items-center mt-4">Enter your email and we'll send you a six digit </h1>
        <h1 class="w-full  flex justify-center items-center mt-1">code to reset your password.</h1>
    <div class="w-full p-6 flex justify-center items-center">
      <div class="w-full max-w-md border bg-slate-100 border-gray-400 mb-12">
        <div class=" p-8 shadow rounded mb-6">
          <div class="mb-6 text-lg  font-thin"><span class="text-2xl text-white-900">Reset your password</span></div>
          ...
          <button
            @click.prevent="SubmitForgetPassword()"
          ...
          >
            ...
            <span :class="{ invisible: isLoading }"
              ><span class="text-xl">Reset</span></span
            >
          </button>
        </div>
...
const SubmitForgetPassword = async () => {
  ...
  try {
    let res = await axios.post("http://127.0.0.1:8000/api/forget-password", {
      email: email.value,
    ...
    Swal.fire({
          ...
          icon: "success",
          title:
            "We have sent you the code via your email",
          animation: true,
          position: "top-end",
