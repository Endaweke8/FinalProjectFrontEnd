      ...
      <div class="mt-8 overflow-hidden">
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6 mr-2 bg-blue-50 dark:bg-blue-500 sm:rounded-lg">
            <h1
              class="text-4xl sm:text-5xl text-blue-500 dark:text-white font-extrabold tracking-tight"
            >
              Get in touch
            </h1>
            <p
              class="bg-gradient-to-r from-green-400 to-blue-500 ...,text-normal text-lg sm:text-2xl font-medium text-white-500 dark:text-white-500 mt-2"
            >
          ...
          <form class="max-w-sm m-auto">
            <div class="flex flex-col items-center mt-7">
              ...
              />
              <p v-if="v$.name.$error" class="text-red-600 mt-3">
              ...
              <input
                ...
                autocomplete="email"
              />
              <p v-if="v$.email.$error" class="text-red-600 mt-3">
              ...
              <textarea
                ...
                class="w-full p-2 rounded-xl bg-none border border-gray-500"
              ></textarea>
              <p v-if="v$.message.$error" class="text-red-600 mt-3">
                This field cannot be empty
              </p>
            </div>
            ...
            <button
              @click="sumbitForm"
              class="bg-green-500 text-white py-2 px-4 mt-5 rounded"
            >
              Submit
            </button>
          </form>
...
const { mutate: insert_users_messages, onDone } = useMutation(
  gql`
    mutation insert_users_message(
      $name: String!
      $email: String!
      $message: String!
    ) {
...
onDone(() => {
  ...
  Swal.fire({
    toast: true,
    icon: "success",
    title: "You send the message successfully ",
    animation: true,
    position: "top-end",
