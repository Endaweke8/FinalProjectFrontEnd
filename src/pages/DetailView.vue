    ...
    <div>
      ...
      >
        <div class="w-75% lg:flex ">
          ...
          >
            <img :src="item.image_name" alt="" width="900" class="card-zoom-image w-96 h-96" />
          </div>
          <div
          ...
          >
            <div class="mb-8 ">
              <p class="text-sm text-gray-600 flex items-center">
               ...
               <span class="text-gray-900 text-lg italic"> Name:-{{ item.name }}</span>
              </p>
              ...
              <div class="text-gray-900 italic mb-2">
                <span class="text-lg">Category :-{{ item.subcategory }}</span>
              </div>
              <div class="text-gray-900 italic mb-2">
                <span class="text-lg">Type :-{{ item.subcategory1 }}</span>
              </div>
              ...
              <span class="text-3xl mt-5 mb-5 italic text-gray-900 dark:text-white"
                >Available quantity :{{ item.productquantity }} </span
              >
              <br>
              <span class=" mt-5 mb-5  text-gray-900 dark:text-white"
                ><span class="text-3xl">Selling Price :</span><span class="font-bold text-3xl">{{ item.price }} Birr</span></span
              >
