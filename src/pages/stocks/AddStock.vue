<template>
  <div id="EditProfile" class="container max-w-4xl mx-auto pt-20 pb-20 px-6">
    ...
    <div
      class="bg-green-500 w-full h-1 shadow-2xl shadow-gray-700 border-4 border-gray-500"
    ></div>
    ...
    <div class="shadow-2xl shadow-gray-700 border-4 border-gray-500">
      ...
      <div class="flex flex-wrap mt-4 mb-6">
        <div class="w-full md:w-1/2 px-3">
          ...
          <input
            ...
            id=""
            placeholder="Enter the stock sale Price"
            class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
          />
      ...
      <div class="flex flex-wrap mt-4 mb-6">
        <div class="w-full md:w-1/2 px-3">
          ...
          <input
            ...
            v-model="stock.slug"
            id=""
            placeholder="Enter the stock slug"
            class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
          />
      ...
      <div class="flex flex-wrap mt-4 mb-6">
        <div class="w-full md:w-1/2 px-3">
          <input
            ...
            id=""
            placeholder="Enter the stock image"
            class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
          />
        </div>
        <img
  ...
  <div class="flex flex-wrap mt-8 mb-6">
    <div class="w-full px-3">
      <SubmitFormButton btnText="Add stock" @click="save" />
    </div>
  </div>
</template>
