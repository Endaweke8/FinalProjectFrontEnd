 ...
 <TopNavigation />
    ...
    <div class="bg-gray-200">
      <div id="stockorderus" class="container max-w-4xl mx-auto pt-20 pb-20 px-6">
        <div class="text-gray-900 text-xl">Sells Your  Stock</div>
        ...
        <div class="flex flex-wrap mt-4 mb-6">
          <div class="w-full ">
            <label
              class="block uppercase tracking-wide text-xs font-bold text-gray-900 mb-2"
            >
              Enter The stock type You want to sell
            </label>
            <input
              type="text"
              name=""
              ...
              class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            />
            <p class="text-red-600" v-if="errors.stockType">
              * {{ errors.stockType[0] }}
            </p>
          </div>
        </div>
        ...
        <div class="flex flex-wrap mt-4 mb-6">
          <div class="w-full ">
            ...
            <input
              ...
              v-model="amount"
              id=""
              placeholder="100,000birr"
              class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            />
            <p class="text-red-600" v-if="errors.amount">
              * {{ errors.amount[0] }}
            </p>
          </div>
        </div>
        <div class="flex flex-wrap mt-4 mb-6">
          <div class="w-full ">
            <label
              class="block uppercase tracking-wide text-xs font-bold text-gray-900 mb-2"
            >
              Enter The Selling Price You want to sell
            </label>
            <input
              type="text"
              name=""
              ...
              class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            />
            <p class="text-red-600" v-if="errors.selling_price">
        ...
        <div class="w-full px-3">
          ...
          <textarea
            ...
            cols="30"
            rows="10"
            placeholder="I want to sell 10,000cbe birr"
            v-model="description"
          ></textarea>
  ...
  const Submit = async () => {
    ...
    try {
      const res = await axios.post(
        "http://127.0.0.1:8000/api/sellstock",{
