<template>
  ...
  <div class="text-3xl font-bold">This Week's Stock Request Report</div>
</div>
...
import Swal from 'sweetalert2'
 ...
 const getstockrequests=async()=>{
    let res=await axios.get('http://127.0.0.1:8000/api/get_all_stockrequestsweeklyreport?page=' + page.value)
