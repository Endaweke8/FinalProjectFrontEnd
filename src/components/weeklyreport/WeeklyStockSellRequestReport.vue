<template>
  ...
  <div class="text-3xl font-bold">This Week's  Stock Sell Request Report</div>
</div>
...
import Swal from 'sweetalert2'
 ...
 const getsellstockrequests=async()=>{
    let res=await axios.get('http://127.0.0.1:8000/api/get_all_sellstockrequestsweeklyreport?page=' + page.value)
