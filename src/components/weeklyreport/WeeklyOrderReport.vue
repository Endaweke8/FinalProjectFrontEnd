<template>
  ...
  <div>
    <div class="italic mb-3">
      ...
      <div class="text-3xl mt-5 font-bold">This Week's Orders Report</div>
    </div>
    ...
    <div>
      <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
        ...
        <table
          id="myVueComponent"
          class="w-full my-component border-collapse border border-slate-400 text-sm text-left text-gray-500 dark:text-gray-400"
        >
          <thead
          ...
          <tbody>
            ...
            <td class="py-4 px-1 border border-slate-300"></td> -->
              <td
                class="py-4 px-1 border border-slate-300 text-xl text-black font-bold"
              >
                {{ weeklyorderreport.totalWeeklySaleAmount }}
              </td>
              <td
                class="py-4 px-1 border border-slate-300 text-xl text-black font-bold"
              >
                {{ weeklyorderreport.totalWeeklyBuyingAmount }}
              </td>
              <td
                class="py-4 px-1 border border-slate-300 text-xl text-black font-bold"
              >
                {{ weeklyorderreport.totalProfit }}
              </td>
              <td class="py-4 px-1 border border-slate-300"></td>
              <td class="py-4 px-1 border border-slate-300"></td>
              <td class="py-4 px-1 border border-slate-300"></td>
...
const getOrders = async () => {
  let res = await axios.get(
    "http://127.0.0.1:8000/api/getweeklyreportorders?page=" + page.value
  );

  pageCount.value = res.data.page_count;
  orders.value = res.data.orders.data;
  weeklyorderreport.value = res.data;
