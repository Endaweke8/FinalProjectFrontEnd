<template>
  <div>
    <div class="italic mb-3">
      <div class="text-3xl font-bold">Today's Pending Orders</div>
      ...
      <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
        ...
        >
          ...
          <tbody>
            <tr
              v-for="order in todayspendingorders"
              :key="order.id"
      ...
      <div class="text-3xl mt-5 font-bold">Older Pending Orders</div>
    </div>
    <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
      <div
        class="flex justify-between items-center pb-4 bg-white dark:bg-gray-900"
...
const getOrders = async () => {
  let res = await axios.get(
    "http://127.0.0.1:8000/api/pendingorders?page=" + page.value
  );
...
const gettodayspendingorders = async () => {
  let res = await axios.get(
  ...
  // pageCount.value = res.data.page_count;
  // orders.value = res.data.orders.data;
  todayspendingorders.value = res.data.orders.data;
  console.log("Today's Pening Order is", res.data.todayspendingorders.data);
  isLoading.value = false;
  // if(res.data.products.data){
  //   isLoading.value=false;
  // }
