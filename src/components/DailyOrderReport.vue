          ...
          <tbody>
            ...
            <td class="py-4 px-1 border border-slate-300"></td> -->
              <td
                class="py-4 px-1 border border-slate-300 text-xl text-black font-bold"
              >
                {{ dailyorderreport.totalDailySaleAmount }}
              </td>
              <td
                class="py-4 px-1 border border-slate-300 text-xl text-black font-bold"
              >
                {{ dailyorderreport.totalDailyBuyingPrice }}
              </td>
              <td
                class="py-4 px-1 border border-slate-300 text-xl text-black font-bold"
              >
                {{ dailyorderreport.totalProfit }}
              </td>
              <td class="py-4 px-1 border border-slate-300"></td>
              <td class="py-4 px-1 border border-slate-300"></td>
              <td class="py-4 px-1 border border-slate-300"></td>
...
const getOrders = async () => {
  ...
  dailyorderreport.value = res.data;
