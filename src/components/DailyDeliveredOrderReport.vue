  ...
  <div id="myVueComponent" class="my-componentttttt">
    <div class="italic mb-3">
      ...
      <div class="text-3xl mt-5 font-bold">
        Today's Delivered Orders Report({{ format }})
      </div>
    </div>
          ...
          <tbody>
            ...
            <td class="py-4 px-1 border border-slate-300"></td> -->
              <td
                class="py-4 px-1 border border-slate-300 text-xl text-black font-bold"
              >
                {{ daily_delivered_sale_amount }}
              </td>
              <td
                class="py-4 px-1 border border-slate-300 text-xl text-black font-bold"
              >
                {{ daily_delivered_buying_price }}
              </td>
              <td
                class="py-4 px-1 border border-slate-300 text-xl text-black font-bold"
              >
                {{ daily_delivered_profits }}
              </td>
              <td class="py-4 px-1 border border-slate-300"></td>
              <td class="py-4 px-1 border border-slate-300"></td>
              <td class="py-4 px-1 border border-slate-300"></td>
...
const daily_delivered_buying_price = ref();
const daily_delivered_profits = ref();
const daily_delivered_sale_amount = ref();
...
const getOrders = async () => {
  ...
  daily_delivered_buying_price.value = res.data.totalDailyDeliveredBuyingPrice;
  daily_delivered_profits.value = res.data.totalDailyDeliveredProfit;
  daily_delivered_sale_amount.value = res.data.totalDailyDeliveredSaleAmount;
