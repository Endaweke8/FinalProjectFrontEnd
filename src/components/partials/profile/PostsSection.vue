        ...
        <div class="flex flex-wrap mb-4">
            <div v-for="post in postStore.posts" :key="post" class="my-1 px-1 w-full md:w-1/2 lg:w-1/2">
                ...
                <div class="rounded-lg border">
                    <a href="#">
                        <img class="rounded-t-lg w-full" :src="'http://127.0.0.1:8000/'+'images/posts/'+post.image" alt="Enyewus post">
                    </a>
...
<script setup>
    ...
    onMounted(async () => {
        // let res = await axios.get('http://127.0.0.1:8000/api/user/' + userStore.id+ '/posts')
