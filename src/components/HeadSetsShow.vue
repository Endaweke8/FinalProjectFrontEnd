...
<div v-if="products" class="flex  bold text-3xl justify-center items-center">Best HeadSets</div>
<div v-else class="flex  bold text-3xl justify-center items-center">No HeadSets</div>
    ...
    <div class="antialiased bg-gray-200 text-gray-900 font-sans p-6">
     ...
     <div v-if="products" class="flex items-center justify-center p-2">
       <v-pagination
         class="p-10"
         v-model="page"
         :pages="pageCount"
   ...
   import axios from 'axios'
       ...
       let res=await axios.get('http://127.0.0.1:8000/api/products/electronics/headsets?page=' + page.value)
