...
<template>
    <div v-if="products.length<=0" class="flex items-center mt-12 h-48  mb-12 justify-center">
      <div class="flex mt-5 bold text-3xl justify-center items-center">Sorry, Button Mobiles aren't Found</div>
    </div>
    ...
    import axios from 'axios'
        ...
        let res=await axios.get('http://127.0.0.1:8000/api/products/electronics/mobiles/buttons?page=' + page.value)
