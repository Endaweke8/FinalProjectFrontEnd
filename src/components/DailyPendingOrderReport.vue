<template>
    ...
    <div class="text-3xl mt-5 font-bold">Today's Pending Orders Report</div>
  </div>
  ...
  const getOrders=async()=>{
    let res=await axios.get('http://127.0.0.1:8000/api/getdailpendingreportorders?page=' + page.value)
