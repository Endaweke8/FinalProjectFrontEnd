    ...
    >
      <SwiperSlide v-for="product in products" :key="product.id">
        <router-link
          ...
          class="max-w-sm w-full lg:h-60 lg:max-w-full lg:flex"
        >
          <div class="items-center justify-center flex">
            <img
              class="h-60 w-auto ml-[20px] rounded-t-lg"
              :src="`${endpoint}/images/productprofiles/` + product.image_name"
              alt=""
            />
          </div>
          <div
            class="border-r lg:h-60 lg:w-full bg-teal-50 border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal"
          >
            <div class="mb-8">
              ...
              <p class="text-gray-700 text-base">
                ...
                <span class="text-blue-800">Read More</span>
              </p>
            </div>
            <div class="flex items-center justify-between mb-2">
              ...
              <router-link
                :to="`/detailview/${product.id}`"
                class="text-white bg-gray-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >Buy Now</router-link
              >
            </div>
          </div>
